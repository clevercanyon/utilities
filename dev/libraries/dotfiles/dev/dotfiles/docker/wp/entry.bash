...
#
# - Instead of editing this file, you can modify `./dev/dotfiles/docker/wp/entry~prj.bash`.
...
if [[ -x "${PROJECT_DIR}"/dev/dotfiles/docker/wp/entry~prj.bash ]]; then
	"${PROJECT_DIR}"/dev/dotfiles/docker/wp/entry~prj.bash;
fi;
# ---------------------------------------------------------------------------------------------------------------------
# Start Apache.
# ---------------------------------------------------------------------------------------------------------------------
