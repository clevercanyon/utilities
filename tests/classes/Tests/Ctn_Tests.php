 ...
 *
 * @since 2021-12-15
 * @coversDefaultClass \Clever_Canyon\Utilities\Ctn
 */
final class Ctn_Tests extends UT\A6t\Tests {
	/**
	 * @covers ::is()
	 */
	...
	public function test_super_merge() : void {
		...
		foreach ( [ [ $obj1, $obj2 ], [ $arr1, $arr2 ] ] as $_ctn ) {
			...
			$_new_ctn = is_array( $_ctn[ 0 ] ) ? new U\Generic( $_new_ctn ) : $_new_ctn;                                                                // Converts back to `Generic` for comparison.
