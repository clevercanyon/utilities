 ...
 *
 * @since 2021-12-15
 * @coversDefaultClass \Clever_Canyon\Utilities\STC\Version_1_0_0\Fs
 */
final class Fs_Tests extends \Clever_Canyon\Utilities__Tests\Framework\Version_1_0_0\A7s_Tests {
	/**
	 * @covers ::normalize()
	 * @covers ::wrappers()
