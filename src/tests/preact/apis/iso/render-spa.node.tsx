...
describe('$preact.iso.renderSPA()', async () => {
    ...
    test('basics', async () => {
        ...
        expect(blogHTTPState.status).toBe(undefined);
        ...
        expect(blogHTML).toMatch(/<script type="module" nonce="[^"]+" src="\.\/script\.js" data-key="scriptBundle"><\/script>/u);
        ...
        expect(blogPostHTTPState.status).toBe(undefined);
        ...
        expect(blogPostHTML).toMatch(/<script type="module" nonce="[^"]+" src="\.\/script\.js" data-key="scriptBundle"><\/script>/u);
        ...
        expect(othersOtherA1HTTPState.status).toBe(undefined);
        ...
        expect(othersOtherA1HTML).toMatch(/<script type="module" nonce="[^"]+" src="\.\/script\.js" data-key="scriptBundle"><\/script>/u);
        ...
        expect(othersOtherA2HTTPState.status).toBe(undefined);
        ...
        expect(othersOtherA2HTML).toMatch(/<script type="module" nonce="[^"]+" src="\.\/script\.js" data-key="scriptBundle"><\/script>/u);
        ...
        expect(othersOtherB1HTTPState.status).toBe(undefined);
        ...
        expect(othersOtherB1HTML).toMatch(/<script type="module" nonce="[^"]+" src="\.\/script\.js" data-key="scriptBundle"><\/script>/u);
        ...
        expect(othersOtherB2HTTPState.status).toBe(undefined);
        ...
        expect(othersOtherB2HTML).toMatch(/<script type="module" nonce="[^"]+" src="\.\/script\.js" data-key="scriptBundle"><\/script>/u);
        ...
        expect(othersOtherC1HTTPState.status).toBe(undefined);
        ...
        expect(othersOtherC1HTML).toMatch(/<script type="module" nonce="[^"]+" src="\.\/script\.js" data-key="scriptBundle"><\/script>/u);
        ...
        expect(othersOtherC2HTTPState.status).toBe(undefined);
        ...
        expect(othersOtherC2HTML).toMatch(/<script type="module" nonce="[^"]+" src="\.\/script\.js" data-key="scriptBundle"><\/script>/u);
        ...
        expect(othersOtherC3HTTPState.status).toBe(undefined);
        ...
        expect(othersOtherC3HTML).toMatch(/<script type="module" nonce="[^"]+" src="\.\/script\.js" data-key="scriptBundle"><\/script>/u);
        ...
        expect(othersOtherD1HTML).toMatch(/<script type="module" nonce="[^"]+" src="\.\/script\.js" data-key="scriptBundle"><\/script>/u);
        ...
        expect(othersOtherD2HTTPState.status).toBe(undefined);
        ...
        expect(othersOtherD2HTML).toMatch(/<script type="module" nonce="[^"]+" src="\.\/script\.js" data-key="scriptBundle"><\/script>/u);
        ...
        expect(othersOtherD3HTTPState.status).toBe(undefined);
        ...
        expect(othersOtherD3HTML).toMatch(/<script type="module" nonce="[^"]+" src="\.\/script\.js" data-key="scriptBundle"><\/script>/u);
        ...
        expect(othersOtherE1HTTPState.status).toBe(undefined);
        ...
        expect(othersOtherE1HTML).toMatch(/<script type="module" nonce="[^"]+" src="\.\/script\.js" data-key="scriptBundle"><\/script>/u);
        ...
        expect(othersOtherE2HTTPState.status).toBe(undefined);
        ...
        expect(othersOtherE2HTML).toMatch(/<script type="module" nonce="[^"]+" src="\.\/script\.js" data-key="scriptBundle"><\/script>/u);
        ...
        expect(othersOtherE3HTML).toMatch(/<script type="module" nonce="[^"]+" src="\.\/script\.js" data-key="scriptBundle"><\/script>/u);
        ...
        expect(othersOtherE4HTTPState.status).toBe(undefined);
        ...
        expect(othersOtherE4HTML).toMatch(/<script type="module" nonce="[^"]+" src="\.\/foo\.js" data-key="scriptBundle"><\/script>/u);
