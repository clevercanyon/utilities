...
import { $env, $is, $obj, $symbol, $brand, $time, $url } from '../index.js';
...
describe('$is tests', async () => {
	...
	test('$is.structuredCloneable()', async () => {
