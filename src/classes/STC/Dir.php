 ...
 * @since 2021-12-15
 */
class Dir extends \Clever_Canyon\Utilities\STC\Abstracts\A6t_Stc_Utilities {
	/**
	 * Joins paths.
	 *
	 * @since 2021-12-19
	...
	public static function make_temp( string $dir = '', int $perms = 0700, bool $recursively = true ) : string {
		...
		if ( ! U\Dir::make( $dir, $perms, $recursively ) ) {
			throw new Fatal_Exception( 'Unable to create temp directory: `' . $dir . '`.' );
		}
		return $dir;
	}
	 ...
	 *
	 * @throws Fatal_Exception On failure to locate temp dir.
	...
	public static function sys_temp() : string {
		...
		throw new Fatal_Exception( 'Unable to locate system temp directory. None of the usual locations are writable.' );
	}
