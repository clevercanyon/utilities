 ...
 * @since 2021-12-15
 */
class Obj extends \Clever_Canyon\Utilities\STC\Abstracts\A6t_Stc_Utilities {
	/**
	 * Object is empty?
	 *
	 * @since 2021-12-16
	 ...
	 *    but offsets are publicly-accessible through `[]` syntax in supporting instances of {@see I7e_Offsets}.
	 *
	 ...
	 *        For example, `public+` returns `"\0"+"\0"offsets` for instances of {@see I7e_Offsets}.
	 *
	...
	public static function props( object $obj, /* string|null */ ?string $filter = null ) : array {
		...
		if ( 'debug' !== $filter ) {
			...
			unset( $props[ "\0" . A6t_Base::class . "\0" . 'oop_cache' ] );
		}
		return $props;
	}
