...
trait Remove_Query_Members {
	 ...
	 */
	public static function remove_query_vars( array $vars, string $url, /* int|string */ $strategy = PHP_QUERY_RFC3986 ) : string {
