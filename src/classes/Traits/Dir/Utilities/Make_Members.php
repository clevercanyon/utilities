...
trait Make_Members {
	 ...
	 */
	public static function make( string $dir, array $perms = [ 0700, 0700 ], bool $recursively = true ) : bool {
	 ...
	 */
	public static function make_temp( string $dir = '', array $perms = [ 0700, 0700 ], bool $recursively = true ) : string {
