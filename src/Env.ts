...
export default class $Env {
	...
	public static isWeb() : boolean {
		...
		return $Env.cache.isWeb = // Memoize.
	...
	public static isNode() : boolean {
		...
		return $Env.cache.isNode = // Memoize.
	...
	public static isCfw() : boolean {
		...
		return $Env.cache.isCfw = $Env.isServiceWorker() // Memoize.
	...
	public static isWorker() : boolean {
		...
		return $Env.cache.isWorker = // Memoize.
	...
	public static isDedicatedWorker() : boolean {
		...
		return $Env.cache.isDedicatedWorker = // Memoize.
	...
	public static isSharedWorker() : boolean {
		...
		return $Env.cache.isSharedWorker = // Memoize.
	...
	public static isServiceWorker() : boolean {
		...
		return $Env.cache.isServiceWorker = // Memoize.
