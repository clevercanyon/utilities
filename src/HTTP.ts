...
export default class $HTTP {
	...
	public static requestPathIsDynamic(request: Request, parsedURL: URL | null = null): boolean {
		return (
			$HTTP.requestPathHasDynamicBase(request, parsedURL) ||
			$HTTP.requestPathIsPotentiallyDynamic(request, parsedURL) ||
	 ...
	 */
	public static supportedRequestMethods: Array<string> = ['OPTIONS', 'HEAD', 'GET', 'POST', 'PUT', 'PATCH', 'DELETE'];
